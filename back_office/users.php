...
<body>
    ...
    <div id="main-wrapper">
        ...
        <?php
          ...
          $querySelect = $conexao->query("SELECT * FROM users ");

          while($registos= $querySelect->fetch_assoc()){

              $id             = $registos['id'];
              $username       = $registos['username'];
              $email          = $registos['email'];
              $permissoes     = $registos['permissoes'];
           ...
           echo "<tr>";
              ...
              echo "<td>$permissoes</td>";
               ...
               echo "<td><a href="."editar.php?id=$id"." class="."active"." ui-toggle-class=".""."><i style='font-size:40px' class="."ti-pencil-alt"."></i></a></td>";
               echo "<td><a href="."base_de_dados/apagar.php?id=$id onclick='return checkdelete()'"." class="."active"." ui-toggle-class=".""."><i style='font-size:40px' class="."ti-trash"."></i></a></td>";
